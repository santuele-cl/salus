import { getPrescriptionByPrescriptionId, getPrescriptionsByPatientId } from "@/actions/patients/prescriptions";
...
const PrescriptionPage = async ({
  ...
  const response = await getPrescriptionByPrescriptionId
  (prescriptionId);
