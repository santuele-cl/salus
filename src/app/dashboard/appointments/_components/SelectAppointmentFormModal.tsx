...
const SelectAppointmentFormModal = ({
    ...
    selectEndDate: dayjs.Dayjs,
    setSelectEndDate: Dispatch<SetStateAction<dayjs.Dayjs>>;
    selectStartDate: dayjs.Dayjs,
    setSelectStartDate: Dispatch<SetStateAction<dayjs.Dayjs>>;
