...
exports.LoginSchema = exports.RegisterSchema = exports.NewPasswordSchema = exports.ResetPasswordSchema = exports.SettingsSchema = exports.EvaluationSchema = exports.VitalsSchema = exports.VisitSchema = void 0;
...
exports.EvaluationSchema = z.object({
    heightInCm: z.number(),
    weightInKl: z.number(),
    bodyTemperatureInCelsius: z.number(),
    hbloodPressurepi: z.string().min(1, "This field is required"),
...
exports.RegisterSchema = z.object({
    ...
    // CONSENT
    consent: z.boolean().refine(function (value) { return value === true; }, {
